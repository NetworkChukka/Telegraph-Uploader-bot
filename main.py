...
# ##Credits - [telegraph-uploader-bot] (https://github.com/NetworkChukka/Telegraph-Uploader-bot)

# Read GNU General Public License v3.0: https://github.com/NetworkChukka/Telegraph-Uploader-bot/blob/mai/LICENSE
# Don't forget to follow github.com/NetworkChukka because I'm doing these things for free and open source
# Star, fork, enjoy!
...
INLINE_SELECT = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("Github🤩", url="https://github.com/NetworkChukka/Telegraph-Uploader-bot"),
            InlineKeyboardButton("Report Bugs🤖", url="https://t.me/anonymousbotzchat")
        ],
        [
            InlineKeyboardButton("Join Channel🌐", url="https://t.me/anonymousbotz")
        ]
    ]
)
...
ERROR_BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("Report Bugs🤖", url="https://t.me/anonymousbotzchat"),
            InlineKeyboardButton("Learn Boot🙂", url="https://t.me/anonymousbotzchat")
        ]
    ]
)
...
async def start(bot, message):
    text = f"Hello {message.from_user.first_name}!\n\nWelcome to the Telegraph uploader bot.\nYou can send me any " \
           ...
           f"<a href=https://t.me/anonymousbotzchat>Feel free to leave a feedback</a>"
...
async def photo_upload(bot, message):
    ...
    try:
        ...
        IN_BUTTON = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Github🤩", url="https://github.com/NetworkChukka"),
                    InlineKeyboardButton("Report Bugs🤖", url="https://t.me/anonymousbotzchat")
                ],
                [
        ...
        await msg.edit_text(
            "File must be less than 5mb, please try another file or <a href=https://t.me/anonymousbotzchat>LEARN THIS BOT FIRST!</a>",
        ...
        await t.edit_text(
            f"Link - `{generated_link} `\n\n<a href=https://t.me/anonymousbotzchat>Feel free to leave a feedback</a>",
...
async def sticker_upload(bot, message):
    ...
    try:
        ...
        await msg.edit_text(
            f"❌ This sticker was unable to upload. Please try another file or <a href=https://t.me/anonymousbotzchat>LEARN THIS BOT FIRST!</a>\n\n<i>Caused error - {a}</i>",
            reply_markup=INLINE_SELECT,
            disable_web_page_preview=True)
    else:
        t = await msg.edit_text(generated_link, disable_web_page_preview=True)
